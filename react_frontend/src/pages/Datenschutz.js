      ...
      <Row>
        <Col lg={12} md={12} sm={12} xl={12} xs={12}>
          <div className="text-black m-5" style={{ lineHeight: '250%' }}>
            <h2 className='mb-5'>DATENSCHUTZBESTIMMUNGEN</h2>
            <p>
            ...
            <h3>1. GELTUNGSBEREICH UND GEGENSTAND DER DATENSCHUTZERKLÄRUNG</h3>
            <p>
              Diese Datenschutzerklärung gilt für das Internet-Angebot unter https://landschaft-lieben.de der Kreisverwaltung Kusel und die dort angebotenen eigenen Inhalte. Wir verarbeiten Ihre personenbezogenen Daten nur im erforderlichen Umfang.
            </p>

            <h3>2. VERANTWORTLICHER</h3>
            <p>
              Kreisverwaltung Kusel<br />
              Trierer Straße 49-51<br />
              66869 Kusel<br />
              Tel. 06381/ 424 0<br />
              Fax: 06381/ 424 440<br />
              kreisverwaltung@landkreis-kusel.de
            </p>

            <h3>3. BEAUFTRAGTER FÜR DEN DATENSCHUTZ</h3>
            <p>
              Kreisverwaltung Kusel<br />
              ...
              66869 Kusel<br />
              Tel. 06381/ 424 0<br />
              Fax: 06381/ 424 50220<br />
              datenschutzbeauftragter@landkreis-kusel.de
            </p>
            <p>
            ...
            <p>
              Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Rechtsgrundlage für die Verarbeitung ist Art.6 Abs. 1 S. 1 lit. f) DS-GVO.
            </p>
            ...
            <h5>Beschwerde:</h5>
            <p>
              Wenn Sie glauben, dass wir bei der Verarbeitung Ihrer personenbezogenen Daten datenschutzrechtliche Vorschriften nicht beachtet haben, können Sie sich bei der Aufsichtsbehörde beschweren. Aufsichtsbehörde ist der Landesbeauftragte für den Datenschutz und die Informationsfreiheit Rheinland-Pfalz, Hintere Bleiche 34, 55116 Mainz, Telefon: +49 6131 2082449, poststelle@datenschutz.rlp.de.
            </p>
            <p>
